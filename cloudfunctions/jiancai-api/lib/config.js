 ...
 * {GAMEKEY_UPPER}_WX_APPID / _WX_SECRET
 * {GAMEKEY_UPPER}_TT_APPID / _TT_SECRET
 *
 * 集合命名约定：
 *   ${GAME_KEY}_playerData     微信 / 匿名
 *   ${GAME_KEY}_tt_playerData  抖音
 */

const DEFAULT_GAME_KEY = 'jiancai';
...
/**
 * 集合名：微信 jiancai_playerData，抖音 jiancai_tt_playerData。
 * 可用 {SCOPED_GAME_KEY}_{SUFFIX}_COLLECTION 环境变量覆盖。
 */
