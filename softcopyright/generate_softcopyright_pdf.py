...
严格按中国版权保护中心常用提交要求生成:
  ...
  9. 第 1 页第 1 行从小游戏入口 minigame/game.js 开始
...
OUTPUT = ROOT / 'softcopyright' / '软著源程序-扫荡菜场-V1.0.0.pdf'
...
# 入口优先: minigame/game.js -> runtime -> src/main.ts, 再收集其余客户端与后端源码
SOURCE_PATTERNS = [
    'minigame/game.js',
    'minigame/runtime.js',
    'src/main.ts',
...
def main():
    ...
    extract = '全部提交' if total_source_pages <= FRONT_PAGES + BACK_PAGES \
        else f'前 {FRONT_PAGES} 页 + 后 {BACK_PAGES} 页'
    print(f'  提取方式:     {extract}')
